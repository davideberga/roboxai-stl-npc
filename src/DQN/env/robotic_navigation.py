...
class RoboticNavigation( gym.Env ):
	...
	def __init__( self, step_limit=300, worker_id=0, editor_build=False, env_type="training", random_seed=0, render=False ):
	...
	def override_reward( self, state, reward, action, done):
		...
		return ((self.target_distance - new_distance) * reward_multiplier) - step_penalty
